...
/* 
  Get Trade Base Fee
  GET /api/v1/base-fee?symbol=${symbol}
  Get Trade Fee
  Get Trade Base Fee
  params: {
...
*/
Trade.getBaseFee = async function (params) {
  let endpoint = ''
  if (typeof params !== 'undefined' || params != '') {
    endpoint = `/api/v1/base-fee?symbol=${params}`
  } else {
...
/* 
  ...
  params: {
    currencyType: 10 Trading pair (optional, you can inquire fee rates of 10 trading pairs each time at most)
  }
*/
Trade.getActualTradeFee = async function (params = {}) {
  let endpoint = ''
